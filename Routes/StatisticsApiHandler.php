...
class StatisticsApiHandler implements ApiHandlerInterface
{
    ...
    public static function addRoutes(App $app)
    {
        ...
        StatisticsApiHandler::addProtectedRoutes($app);
    }

    public static function addProtectedRoutes(App $app)
    {
        $app->group('/summary',function(RouteCollectorProxy $group){
            $group->get('/calories',self::class.":getTotalCalories");
            $group->get('/distance',self::class.":getTotalDistance");
            $group->get('/duration',self::class.":getTotalDuration");
            $group->get('/avgHeartRate',self::class.":getAvgSpeed");
            $group->get('/avgSpeed',self::class.":getAvgHeartRate");
            $group->get('/avgPace',self::class.":getAvgHeartRate");
            $group->get('/avgMovingSpeed',self::class.":getAvgMovingSpeed");
            $group->get('/sph',__CLASS__.":getSph");
